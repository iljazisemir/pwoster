...
const CreateQuoteTweet = ({ quoteTweetId, setPopupQuoteTweet, popupQuoteTweet }) => {
     ...
     <div className="popup-create-post" >
      <div className="popup-create-post-container" >
        <div className="top-container-popup-create" >
          <CrossSvg className="cross-popup-update"  
          onClick={() => setPopupQuoteTweet(false)}
          />
        </div>
     <div className="main-create-post-container">
    <div className="container-create-post" >
      <div className="top-container-create-post">
        <div onClick={() => setRedirectProfile(true)}>
          <img
...
export default CreateQuoteTweet;